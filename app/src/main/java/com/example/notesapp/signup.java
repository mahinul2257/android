    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        msignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(getApplicationContext(),"Required Email and Password",Toast.LENGTH_SHORT).show();
                }
                else if(password.length()<7)
                {
                    Toast.makeText(getApplicationContext(),"Type your password 7 Digits+",Toast.LENGTH_SHORT).show();
                }
                else
                {
